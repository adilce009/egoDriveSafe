...
class SimulationDataset:
    def __init__(self, scene_dataset_batch: Dict[int, EgoDatasetVectorized], sim_cfg: SimulationConfig) -> None:
        ...
        :param sim_cfg: the simulation configs
        """
        if not len(scene_dataset_batch):
            raise ValueError("can't build a simulation dataset with an empty batch")
        self.scene_dataset_batch: Dict[int, EgoDatasetVectorized] = scene_dataset_batch
    ...
    @staticmethod
    def from_dataset_indices(dataset: EgoDatasetVectorized, scene_indices: List[int],
        ...
        :param sim_cfg: a simulation configs
        ...
        scene_dataset_batch: Dict[int, EgoDatasetVectorized] = {}  # dicts preserve insertion order
