...
def build_vectorizer(cfg: dict, data_manager: DataManager) -> Vectorizer:
    """Factory function for vectorizers, reads the configs, loads required data and initializes the vectorization.
    ...
    Returns:
        Vectorizer: Vectorizer initialized given the supplied configs.
    """
